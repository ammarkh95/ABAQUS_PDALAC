...
!  Can be used to debug and verify the execution of constitutive law prior to applying it to ABAQUS     !
																										!
!  Failure Criterion: (Max Stress)  Damage Criteria: (Gradual Stiffness reduction)                    !                                                                                            		!
																										!	
!  Date: 25.10.2019																						!
																										!	
...
!==================================================
	...
	Xt=100   ! Tension Strength in normal 1-direction
		...
		DO I= 1,nblock ! Loop through all material points
        	...
        	DO J=1,3   ! Loop through normal stress components 
        		...
        		IF((e(I,J).GT.1.0) .AND. (StressNew(I,J).GE.0.0)) THEN  ! Check for tensile failure
					...
					Dmg(I,J)= Dmg(I,J)*(1.0/e(I,J))  ! Apply tensile damage such that failure index doesn't excced one
    			...
    			ELSE IF((e(I,J).GT.1.0) .AND. (StressNew(I,J).LT.0.0)) THEN  ! Check for compressive failure
					...
					Dmg(I,J)= Dmg(I,J)*(1.0/e(I,J))  ! Apply compressive damage such that failure index doesn't excced one
        	...
        	DO J=4,6   ! Loop through shear stress components 
				...
				IF((e(I,J).GT.1.0)) THEN  ! Check for shear failure
					...
					Dmg(I,J)= Dmg(I,J)*(1.0/e(I,J))  ! Apply shear damage such that failure index doesn't excced one
