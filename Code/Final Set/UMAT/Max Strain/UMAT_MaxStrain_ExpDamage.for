...
C*************************************************************************
! 3D ORTHOTROPIC ELATICITY WITH MAX STRAIN CRITERION AND PLY-DISCOUNT DAMAGE
! DAMAGE MODEL: EXPONENTIAL DEGREDATION
...
!#----------------------------------------------------------#
    ...
    subroutine damage_calc (STRESS,UPSTRAN,dmg,e,fflags,KINC,&
    &EpsXt,EpsXc,EpsYt,EpsYc,EpsZt,EpsZc,GamS12,GamS13,GamS23,a_ft,a_fc,a_mt,a_mc,a_s,n_ft,n_fc,n_mt,n_mc,n_s)    
