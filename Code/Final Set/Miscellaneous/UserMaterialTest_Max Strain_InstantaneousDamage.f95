...
!  Can be used to debug and verify the execution of constitutive law prior to applying it to ABAQUS     !
																										!
!  Failure Criterion: (Max Strain)  Damage Criteria: (Instantaneous Stiffness reduction)                    !                                                                                            		!
																										!	
!  Date: 25.10.2019																						!
																										!	
...
!==================================================================
		...
		DO I= 1,nblock ! Loop through all material points
        	...
        	DO J=1,3   ! Loop through normal stress components 
        		...
        		IF((e(I,J).GT.1.0) .AND. (Strain(I,J).GE.0.0)) THEN  ! Check for tensile failure
    			...
    			ELSE IF((e(I,J).GT.1.0) .AND. (Strain(I,J).LT.0.0)) THEN  ! Check for compressive failure
