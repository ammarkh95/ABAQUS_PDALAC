...
!  Can be used to debug and verify the execution of constitutive law prior to applying it to ABAQUS     !
																										!
!  Failure Criterion: (Tsai-Wu)  Damage Criteria: (Recursive Stiffness reduction)                       !                                                                                            		!
																										!	
!  Date: 25.10.2019																						!
																										!	
...
!==================================================================
        ...
        DO I= 1,nblock ! Loop through all material point and check damage initiation      
         	...
         	IF ((Phi(I).GT. 1.0).OR.(Dmg(I,IMAX(I)).LT. 1.0)) THEN  ! check for previous damage or if Tsai-Wu failure polynomial excceds one
