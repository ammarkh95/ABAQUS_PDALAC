...
C*************************************************************************
! 3D ORTHOTROPIC ELATICITY WITH PUCK CRITERION AND PLY-DISCOUNT DAMAGE
! DAMAGE MODEL: CONSTANT STRESS DEGREDATION
...
!###########        Failure Evaluation: Puck      ###########
!#----------------------------------------------------------#       	  
   
    call failure_calc(STRESS,UPSTRAN,e,Xt,Xc,Yt,Yc,Zt,Zc,S12,S13,S23,THETAF,MGF,ANU12,ANU12f,E11,E11f)  
          
!###########      Damage Evaluation: Const        ###########
!#----------------------------------------------------------#
...
!#----------------------------------------------------------#
    ...
    subroutine failure_calc(STRESS,UPSTRAN,e,Xt,Xc,Yt,Yc,Zt,Zc,S12,S13,S23,THETAF,MGF,ANU12,ANU12f,E11,E11f)
    
    implicit none
    real*8, dimension  (6) :: e,STRESS,UPSTRAN
    real*8 :: Xt,Xc,Yt,Yc,Zt,Zc,S12,S13,S23,ANU12,E11,THETAF,MGF,ANU12f,E11f
